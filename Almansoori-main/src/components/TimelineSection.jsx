    ...
    <section className="py-8 md:py-12 px-4 md:px-9 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-6 md:mb-8">
          <h2 className="section-heading whitespace-normal md:whitespace-nowrap">our journey</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 relative pl-4 sm:pl-6">
            {/* Vertical Spine Line */}
            <div className="absolute left-9 sm:left-11 top-5 bottom-5 w-1 bg-gray-200 rounded-full" />
            <div
              className="absolute left-9 sm:left-11 top-5 w-1 bg-heading rounded-full transition-all duration-500 ease-in-out"
              style={{
              ...
              {timelineData.map((item, index) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3.5 p-2 pr-5 rounded-full transition-all duration-300 text-left ${
                      isActive
                  ...
                  >
                    {/* Avatar Circle */}
                    <div className="w-11 h-11 md:w-12 md:h-12 rounded-full overflow-hidden flex-shrink-0 border-2 border-white shadow-sm">
                      <img
                    ...
                    <div className="flex flex-col min-w-0 flex-1">
                      <span className={`font-primary text-lg md:text-xl ${isActive ? "text-white" : "text-heading"}`}>
                        {item.year}
                      </span>
          ...
          <div className="lg:col-span-7">
            <div className="bg-gray-50/80 border border-gray-200/80 rounded-3xl p-5 md:p-6 shadow-xl transition-all duration-500">
              {/* Image Container */}
              <div className="relative h-[200px] sm:h-[240px] md:h-[260px] rounded-2xl overflow-hidden group shadow-md mb-4">
                <img
              ...
              <div className="space-y-2.5">
                <h3 className="font-primary text-xl md:text-2xl text-heading leading-tight">
                  <BrandText>{activeItem.title}</BrandText>
                </h3>
                <p className="text-body text-xs sm:text-sm md:text-base leading-relaxed">
